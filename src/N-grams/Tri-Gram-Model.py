...
def language_identify_evaluate(file_address, st, model): # argument 'st' denotes whether you are uploading a file or directly copying text
    ...
    final_dist = {}
    for lang in tri_dist.keys():
        final_dist[lang] =tri_dist[lang]
    sum_dist = 1
...
models_root_path = './Tri-Models/'
bi_sorted        = "../../../../../ext_data/thapelo/CTEXT_Work/AlignedGov/Tri-Gram-Alinged/"
...
if __name__ == "__main__":
        ...
        with open('./N-Gram_Results-clean-dataset/Tri-gram-results/N_3_test_gram_evaluation_doc_clean_data.txt', 'w') as e_file:
        ...
        with open('./N-Gram_Results-clean-dataset/Tri-gram-results/N_3_dev_gram_evaluation_doc_clean_data.txt', 'w') as e_file:
                                #    e_file.write(f'For {item} : model correclty predicted {values[1]/values[1]*100}% of {values[0]} sentences \n')
                                e_file.write(str(list(dev_evals.keys())) + ' ||| ' + str([values[0]/values[1]*100 for values in list(dev_evals.values())])) 
        fname = "N-Gram_Results-clean-dataset/Tri-gram-results/conf_trigram_clean.jpeg" 
        fname_pdf = "N-Gram_Results-clean-dataset/Tri-gram-results/"
        metric_scores = evaluation(true_values, predictions, label2id, fname) 
                # Save results
        output_test_results_file = "./N-Gram_Results-clean-dataset/Tri-gram-results/tri_gram_results_clean_text.txt"
        ...
        #                                     with open(bi_sorted + 'tri_gram_filtered_tsn.txt', 'a') as tsn_file:
        #                                                         tsn_file.write(sentence + '\n') 
        #                                 elif identified_language == "sot":
        #                                     with open(bi_sorted + 'tri_gram_filtered_sot.txt', 'a') as n_file:
        #                                                         n_file.write(sentence + '\n')
        #                                 elif identified_language == 'xho':
        #                                         with open(bi_sorted + 'tri_gram_filtered_xho.txt', 'a') as n_file:
        #                                                         n_file.write(sentence + '\n')   
        #                                 elif identified_language == 'zul':
        #                                     with open(bi_sorted + 'tri_gram_filtered_zul.txt', 'a') as n_file:
        #                                                         n_file.write(sentence + '\n')   
        #                                 elif identified_language == "ssw":
        #                                     with open(bi_sorted + 'tri_gram_filtered_ssw.txt', 'a') as n_file:
        #                                                         n_file.write(sentence + '\n')   
        #                                 elif identified_language == "ven":
        #                                     with open(bi_sorted + 'tri_gram_filtered_ven.txt', 'a') as n_file:
        #                                                         n_file.write(sentence + '\n') 
        #                                 elif identified_language == 'tso':
        #                                         with open(bi_sorted + 'tri_gram_filtered_tso.txt', 'a') as n_file:
        #                                                         n_file.write(sentence + '\n')   
        #                                 elif identified_language == 'af':
        #                                         with open(bi_sorted + 'tri_gram_filtered_af.txt', 'a') as n_file:
        #                                                         n_file.write(sentence + '\n')                                                                                                                                   
        #                                 elif identified_language == 'nbl':
        #                                     with open(bi_sorted + 'tri_gram_filtered_nbl.txt', 'a') as n_file:
        #                                                         n_file.write(sentence + '\n')
        #                                 elif identified_language == 'eng':
        #                                     with open(bi_sorted + 'tri_gram_filtered_en.txt', 'a') as n_file:
        #                                                         n_file.write(sentence + '\n')  
